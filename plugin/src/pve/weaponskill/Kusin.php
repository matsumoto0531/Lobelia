...
class Kusin extends WeaponSkill {
  ...
  public function Imposition($player){
    ...
    $this->plugin->getScheduler()->scheduleDelayedTask(
      new Callback([$this, 'ActionTask'], [$field, $poss, $pos, $player, $players, $atk, $type]), 1);
  }
